...
ttk.Button(mainframe, text='Say bleurgh', command= lambda: printer1().grid(column=1, row=2, sticky=E))
ttk.Button(mainframe, text='Say goodbye', command= lambda: printer2().grid(column=1, row=3, sticky=E))
...
ttk.Label(mainframe, textvariable=print1).grid(column=2, row=3, sticky=E)
ttk.Label(mainframe, textvariable=print2).grid(column=2, row=4, sticky=E)
